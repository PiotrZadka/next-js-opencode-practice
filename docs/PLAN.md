...
## Documentation
- **`docs/TASKS.md`**: Detailed checklist of learning objectives and implementation tasks.
- **`docs/JOURNAL.md`**: Chronological log of decisions, fixes, and session notes.
- **`AGENTS.md`**: Guidelines for the AI agent (commands, conventions).
